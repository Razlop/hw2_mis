...
For the remote repository, make a github repository named Analysis_2, then do;

```bash
git remote add origin git@github.com:razlop/Analysis_2.git
git branch -M main
...
Here's the folder structure that gets created by `cookiecutter-datascience-simple`:
	...
	├── Analysis_2	<- Your notebooks and scripts will live in the main project folder
