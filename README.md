...
For the remote repository, make a github repository named hw2_mis, then do;

```bash
git remote add origin git@github.com:razlop/hw2_mis.git
git branch -M main
...
Here's the folder structure that gets created by `cookiecutter-datascience-simple`:
	...
	├── hw2_mis	<- Your notebooks and scripts will live in the main project folder
